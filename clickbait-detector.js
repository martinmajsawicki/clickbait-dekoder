...
const PATTERNS = [
  ...
  },
  {
    ...
    rules: [
      ...
      { re: /\bsensacj[aąęi]\b/i, snark: '"{0}" — sensacja o trwałości jednego cyklu informacyjnego.' },
      ...
      { re: /katastrofaln[yae]/i, snark: '"{0}" — katastrofalne to Titanik. To jest po prostu złe.' },
  ...
  },
  {
    ...
    rules: [
      ...
      { re: /i\s+(się\s+)?zaczęło/i, snark: '"{0}" — zaczęło się coś, co pewnie szybko się skończyło.' },
