...
const PATTERNS = [
  ...
  },
  {
    ...
    rules: [
      ...
      { re: /\bskandal\b/i, snark: '"{0}" — jedno słowo, zero kontekstu. Idealna przynęta na kliknięcie.' },
      { re: /magiczn[yae]/i, snark: '"{0}" — magia istnieje tylko w nagłówkach. W artykule — normalna arytmetyka.' },
      { re: /odrażając[yae]/i, snark: '"{0}" — odrażające w nagłówku = nieprzyjemne w artykule. Eskalacja słowna.' },
    ],
  },
  {
    id: 'shock_promise',
  ...
  },
  {
    ...
    rules: [
      ...
      { re: /jeden\s+(szczegół|detal|element|powód|krok|cios|błąd|ruch|gest)/i, snark: '"{0}" — jeden szczegół, który nie zmieścił się w tytule, bo jest banalny.' },
